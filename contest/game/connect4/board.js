class Connect4Board {
	...
	constructor (context) {
		...
		this.red = new Image();
		this.yellow.src = "red.png";
		this.red.src = "yellow.png";

		this.board = new Image ();
		this.board.src = "board.png"
	}
	...
	*/
	_draw_stone (coo, player_role) {
		...
		var s = this.hole_size/2
		this.context.drawImage (img, 0, 0, img.width, img.height, coo [0] - s, coo [1] - s, 2*s, 2*s);
	}
	...
	*/
	_draw_board () {
		...
		var iw = this.board.width
		var ih = this.board.height
		var board_w = this.w - this.margin_w * 2
		var board_h = this.cell_size * 6

		this.context.drawImage (this.board, 0, 0, iw, ih, this.margin_w, this.h - this.margin_h - board_h, board_w, board_h);
		return 
