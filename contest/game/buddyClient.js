class BuddyClient extends WebSocketClient
{
	...
	async create_agent (str_target_game, str_model) {
		var data = new Object ()
		data.game = str_target_game
		data.model = str_model
		var handle = this.request ("CreateAgent", data)
		return handle
	}
	...
	async create_contest (game_name, agents, seed=0, player_id=null) {
		var data = new Object ()
		data.game = game_name
		data.agents = agents
		data.seed = seed
		if (player_id != null) data.playerid=player_id
