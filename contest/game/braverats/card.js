class Card extends GameObject {
    ...
    */
	...
	/** ===========================================================================================
	* Change drawing size by a given factor
    */
    set_scale (scale) {
        this._scale = scale
    }
   ...
   draw () {
        ...
        var x = this.x - this._scale * this.w / 2
        var y = this._y_hover - this._scale * this.h / 2
        var img = this._face_img

        if (this.hidden) img = Card._back_img
        this._context.drawImage (img, 0, 0, this._face_img.width, this._face_img.height, x, y, this._scale * this.w, this._scale * this.h);
    }
